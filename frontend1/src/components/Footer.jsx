      ...
      <div className="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        {/* <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            <div
              className="p-2 border border-gray-100 focus-within:ring sm:flex sm:items-center sm:gap-4 dark:border-gray-800"
            >
              <input
                type="email"
                id="UserEmail"
              ...
              <button
                className="w-full px-6 py-3 mt-1 text-sm font-bold tracking-wide text-white uppercase transition-none bg-teal-500 hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Sign Up
              </button>
            </div>
        ...
        <div className="justify-center col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="../pages/home/LatestRecipe.jsx" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                Latest Recipes
              </a>
            </li>
    ...
    <div className="pt-8 mt-8 border-t border-gray-100 dark:border-gray-800">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          &copy; 2024. Foodeasy. All rights reserved.
        </p>
